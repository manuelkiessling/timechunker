...
class TimeChunkerTest < Test::Unit::TestCase
  ...
  def test_chunk_calculation_singlechunk
    expected = [Time.local(2011, 1, 24, 13, 5, 0)]

    time_range = TimeRange.new(Time.local(2011, 1, 24, 13, 57, 0), Time.local(2011, 1, 24, 13, 58, 3))
    five_minutes = ChunkSize.new(5, 'minutes')
  ...
  def test_chunk_calculation_twochunks
    expected = [Time.local(2011, 1, 24, 13, 5, 0)]
